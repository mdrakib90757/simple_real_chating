...
if(mounted){
  ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(content: Text("Registration Successful send email verification link"))
  );
  Navigator.pushReplacement(
    ...
    MaterialPageRoute(builder: (context) => const EmailVerificationScreen()),
      ...
      if(mounted){
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(e.message ?? "error problem"))
        );
      }
    }finally {
      if(mounted){
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: Image.asset("assets/image/chat.png",height: 100,width: 100,color: AppColor.primaryColor,)),
            SizedBox(height: 10,),
            ...
            SizedBox(height: 10,),
            Text("WORLD`S MOST PRIVATE CHATTING APP",style: TextStyle(
                color: AppColor.primaryColor,
                fontWeight: FontWeight.bold,
                fontSize: 15
            ),),
